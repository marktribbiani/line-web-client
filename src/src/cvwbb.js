  ...
  return (
    (j.matches = function (t, e) {
      ...
      var i,
        r = t.parentNode,
        o = !r;
      return o && (r = M).appendChild(t), (i = ~j.qsa(r, e).indexOf(t)), o && M.removeChild(t), i;
    }),
    (i = function (t) {
    ...
    (j.init = function (e, n) {
      ...
      if (!e) return j.Z();
      if ('string' == typeof e)
        if ('<' == (e = e.trim())[0] && d.test(e)) (i = j.fragment(e, RegExp.$1, n)), (e = null);
        else {
        ...
        else if (d.test(e)) (i = j.fragment(e.trim(), RegExp.$1, n)), (e = null);
        else {
          if (n !== t) return $(n).find(e);
          i = j.qsa(c, e);
        }
    ...
    ($.map = function (t, e) {
      var n,
        ...
        o,
        a = [];
      if (R(t)) for (i = 0; i < t.length; i++) null != (n = e(t[i], i)) && a.push(n);
    ...
    ($.fn = {
      ...
      not: function (e) {
        ...
        if (P(e) && e.call !== t)
          ...
          var i = 'string' == typeof e ? this.filter(e) : R(e) && P(e.item) ? a.call(e) : $(e);
      ...
      closest: function (t, e) {
        var n = this[0],
          i = !1;
        for ('object' == typeof t && (i = $(t)); n && !(i ? i.indexOf(n) >= 0 : j.matches(n, t)); )
      ...
      wrapAll: function (t) {
        if (this[0]) {
          var e;
          for ($(this[0]).before((t = $(t))); (e = t.children()).length; ) t = e.first();
          $(t).append(this);
        }
        return this;
      },
      ...
      css: function (t, n) {
        if (arguments.length < 2) {
          ...
          if (!r) return;
          if ('string' == typeof t) return r.style[i(t)] || o.getPropertyValue(t);
          if (T(t)) {
            var a = {};
            return (
        ...
        return e
          ? this.each(function (i) {
              ...
              X(this, e, i, W(this))
                .split(/\s+/g)
                .forEach(function (e) {
                  (n === t ? !r.hasClass(e) : n) ? r.addClass(e) : r.removeClass(e);
                });
            })
          : this;
      },
      ...
      ($.fn[t] = function () {
        var t,
          ...
          r = $.map(arguments, function (e) {
            return 'object' == (t = k(e)) || 'array' == t || null == e ? e : j.fragment(e);
          }),
          o = this.length > 1;
        return r.length < 1
          ? this
        ...
        ($.fn[n ? t + 'To' : 'insert' + (e ? 'Before' : 'After')] = function (e) {
...
(window.Zepto = Zepto),
  ...
  (function ($) {
    ...
    function f(t, e, n, i) {
      if ((e = d(e)).ns)
        var r = ((a = e.ns), new RegExp('(?:^| )' + a.replace(' ', ' .* ?') + '(?: |$)'));
      var a;
        ...
        (o.fn = i),
          ...
          o.e in u &&
            (i = function (t) {
              ...
              if (!e || (e !== this && !$.contains(this, e))) return o.fn.apply(this, arguments);
            }),
          (o.del = s);
        var l = s || i;
        (o.proxy = function (n) {
          ...
          (o.i = g.length),
          g.push(o),
          'addEventListener' in e && e.addEventListener(p(o.e), o.proxy, h(o, c));
      });
    }
    function m(t, e, n, i, r) {
      ...
      (e || '').split(/\s/).forEach(function (e) {
        f(t, e, n, i).forEach(function (e) {
          delete o[a][e.i],
            'removeEventListener' in t && t.removeEventListener(p(e.e), e.proxy, h(e, r));
        });
      });
    }
    (a.click = a.mousedown = a.mouseup = a.mousemove = 'MouseEvents'),
      ...
      ($.proxy = function (t, e) {
        ...
        if (r(e)) return o ? (o.unshift(t[e], t), $.proxy.apply(null, o)) : $.proxy(t[e], t);
      ...
      return (
        (!n && e.isDefaultPrevented) ||
          ...
          (n.defaultPrevented !== t
            ...
            : 'returnValue' in n
            ? !1 === n.returnValue
            : n.getPreventDefault && n.getPreventDefault()) && (e.isDefaultPrevented = v)),
        e
      );
    }
    function C(e) {
          ...
          this.each(function (o, a) {
            ((n = C(r(t) ? $.Event(t) : t))._args = e),
              ...
              $.each(f(a, t.type || t), function (t, e) {
                if (((i = e.proxy(n)), n.isImmediatePropagationStopped())) return !1;
              });
          }),
          i
        );
  ...
  (function ($) {
    ...
    function f(t, e) {
      var n = e.context;
      if (!1 === e.beforeSend.call(n, t, e) || !1 === l(e, n, 'ajaxBeforeSend', [t, e])) return !1;
      l(e, n, 'ajaxSend', [t, e]);
    }
    function d(t, e, n, i) {
      var r = n.context;
    ...
    ($.active = 0),
      ($.ajaxJSONP = function (t, e) {
        ...
        return (
          ...
          $(c).on('load error', function (n, i) {
            clearTimeout(o),
              $(c).off().remove(),
              'error' != n.type && r ? d(r[0], p, t, e) : h(null, i || 'error', p, t, e),
              (window[s] = u),
      ...
      ($.ajax = function (n) {
        ...
        !(function (t) {
          ...
          i.crossDomain ||
            (i.crossDomain =
              /^([\w-]+:)?\/\/([^\/]+)/.test(i.url) && RegExp.$2 != window.location.host),
        ...
        if (
          (v && (p = 'jsonp'),
          (!1 !== i.cache && ((n && !0 === n.cache) || ('script' != p && 'jsonp' != p))) ||
            (i.url = m(i.url, '_=' + Date.now())),
          'jsonp' == p)
        )
          return (
            v || (i.url = m(i.url, i.jsonp ? i.jsonp + '=?' : !1 === i.jsonp ? '' : 'callback=?')),
            $.ajaxJSONP(i, r)
          );
        var y,
          w = i.accepts[p],
        ...
        if (
          ...
          (i.contentType || (!1 !== i.contentType && i.data && 'GET' != i.type.toUpperCase())) &&
            x('Content-Type', i.contentType || 'application/x-www-form-urlencoded'),
          i.headers)
        )
        ...
        if (
          ...
          (S.onreadystatechange = function () {
            if (4 == S.readyState) {
              ...
              } else h(S.statusText || null, S.status ? 'error' : 'abort', S, i, r);
            }
            var n;
          }),
          !1 === f(S, i))
        ...
        for (e in (S.open(i.type, i.url, j, i.username, i.password), b)) E.apply(S, b[e]);
        return (
          i.timeout > 0 &&
            (y = setTimeout(function () {
              (S.onreadystatechange = g), S.abort(), h(null, 'timeout', S, i, r);
            }, i.timeout)),
      ...
      ($.fn.load = function (t, e, n) {
        ...
        return (
          ...
          (s.success = function (t) {
            o.html(i ? $('<div>').html(t.replace(r, '')).find(i) : t), c && c.apply(o, arguments);
          }),
          $.ajax(s),
          this
        );
  ...
  (function ($) {
    ($.Jcrop = function (t, e) {
      ...
      function f(t) {
        'object' != typeof t && (t = {}),
          (i = $.extend(i, t)),
          $.each(['onChange', 'onSelect', 'onRelease', 'onDblClick'], function (t, e) {
            'function' != typeof i[e] && (i[e] = function () {});
          });
      }
      function d(t, e, r) {
        if (((n = u(j)), Y.fdOBfddHKX('move' === t ? t : t + '-resize'), 'move' === t))
      ...
      function p(t) {
        return function (e) {
          return (
            !i.disabled &&
            !('move' === t && !i.allowMove) &&
            ((n = u(j)), (F = !0), d(t, l(e)), e.stopPropagation(), e.preventDefault(), !1)
          );
        };
      }
      function g(t, e, n) {
      ...
      function v(t) {
        var e = V.getFixed();
        e.w > i.minSelect[0] && e.h > i.minSelect[1] ? (Z.enableHandles(), Z.done()) : Z.release(),
      ...
      'object' != typeof t && (t = $(t)[0]), 'object' != typeof e && (e = {}), f(e);
      var x = {
          border: 'none',
          visibility: 'visible',
          margin: 0,
      ...
      } else (j = C.css(x).show()), (S = !1), null === i.shade && (i.shade = !0);
      ...
      var k = $('<div />'),
        ...
        D = $('<div />')
          ...
          .insertBefore(j)
          .append(P, H);
      S && ((k = $('<img />').attr('src', j.attr('src')).css(x).width(M).height(O)), P.append(k)),
      ...
      var J = (function () {
          function t() {
            ...
            try {
              for (t = 0; t < n.length; t++) {
                var r = n[t],
                  o = (r = 'on' + r) in i;
                o || (i.setAttribute(r, 'return;'), (o = 'function' == typeof i[r])), (e[n[t]] = o);
              }
          ...
          return {
            ...
            isSupported: t,
            support: !0 === i.touchSupport || !1 === i.touchSupport ? i.touchSupport : t(),
          };
        })(),
        V = (function () {
          var t,
          ...
          function s() {
            if (!i.aspectRatio)
              return (function () {
                ...
                A / B && Math.abs(i) < A / B && (a = i > 0 ? r + A / B : r - A / B);
                R / z && Math.abs(e) < R / z && (o = e > 0 ? n + R / z : n - R / z);
                n < 0 && ((o -= n), (n -= n));
                r < 0 && ((a -= r), (r -= r));
                o < 0 && ((n -= o), (o -= o));
                a < 0 && ((r -= a), (a -= a));
            ...
            return (
              ...
              v / y < f
                ? ((e = a),
                  (s = y * f),
                  (t = g < 0 ? n - s : s + n) < 0
                    ? ((t = 0), (c = Math.abs((t - n) / f)), (e = m < 0 ? r - c : c + r))
                    : t > M && ((t = M), (c = Math.abs((t - n) / f)), (e = m < 0 ? r - c : c + r)))
                : ((t = o),
                  (c = v / f),
                  (e = m < 0 ? r - c : r + c) < 0
                    ? ((e = 0), (s = Math.abs((e - r) * f)), (t = g < 0 ? n - s : s + n))
                    : e > O && ((e = O), (s = Math.abs(e - r) * f), (t = g < 0 ? n - s : s + n))),
              t > n
          ...
          function u(t, e, n, i) {
            var r = t,
              ...
              a = e,
              s = i;
            return n < t && ((r = n), (o = t)), i < e && ((a = i), (s = e)), [r, a, o, s];
          }
          function l(t) {
            return {
              x: t[0],
          ...
          return {
            ...
            setCurrent: function (n) {
              (n = c(n)), (t = n[0] - o), (e = n[1] - a), (o = n[0]), (a = n[1]);
            },
            getOffset: function () {
              return [t, e];
            },
        ...
        U = (function () {
          ...
          function f(n, r) {
            t &&
              (i.bgFade && !r
                ? e.animate({ opacity: 1 - n }, { queue: !1, duration: i.fadeTime })
                : e.css({ opacity: 1 - n }));
          }
          function d() {
            return e.children();
        ...
        Z = (function () {
          ...
          function u(t, e) {
            var n = $('<div />')
              ...
              .addClass('ord-' + t);
            return J.support && n.bind('touchstart.jcrop', J.createDragger(t)), H.append(n), n;
          }
          function l() {
            var t = V.getFixed();
          ...
          i.dragEdges &&
            ...
            (function (t) {
              var n;
              for (n = 0; n < t.length; n++) o[t[n]] = u(t[n], e++).addClass('jcrop-dragbar');
            })(i.createDragbars),
            ...
            $(document).bind('touchstart.jcrop-ios', function (t) {
              $(t.currentTarget).hasClass('jcrop-tracker') && t.stopPropagation();
            });
          var w = b()
            .mousedown(p('move'))
          ...
          return (
            ...
            v(),
            {
              ...
              update: d,
              release: function () {
                v(), D.hide(), i.shade ? U.opacity(1) : h(1), (t = !1), i.onRelease.call(rt);
              },
              refresh: l,
              isAwake: function () {
                return t;
              ...
              activateHandlers: function (i, c, u) {
                return (
                  ...
                  (function (t) {
                    _.css({ zIndex: 450 }),
                      t
                        ? $(document).bind('touchmove.jcrop', a).bind('touchend.jcrop', s)
                        : n && $(document).bind('mousemove.jcrop', r).bind('mouseup.jcrop', o);
                  })(u),
                  !1
                );
              },
        ...
        G = (function () {
          var t = $('<input type="radio" />')
            ...
            e = $('<div />').css({ position: 'absolute', overflow: 'hidden' }).append(t);
          function n(t, e, n) {
          ...
          return (
            i.keySupport &&
              ...
              a || !i.fixedSupport
                ? (t.css({ position: 'absolute', left: '-20px' }), e.append(t).insertBefore(j))
                : t.insertBefore(j)),
            {
              watchKeys: function () {
      ...
      function tt() {
        (i.disabled = !0), Z.disableHandles(), Z.fdOBfddHKX('default'), Y.fdOBfddHKX('default');
      }
      function et() {
        (i.disabled = !1), it();
      }
      function nt(t, e, n) {
        var r = e || i.bgColor;
        i.bgFade && $.fx.step.hasOwnProperty('backgroundColor') && i.fadeTime && !n
          ? t.animate({ backgroundColor: r }, { queue: !1, duration: i.fadeTime })
          : t.css('backgroundColor', r);
      }
      function it(t) {
        i.allowResize ? (t ? Z.enableOnly() : Z.enableHandles()) : Z.disableHandles(),
          Y.fdOBfddHKX(i.allowSelect ? i.cursor : 'default'),
          Z.fdOBfddHKX(i.allowMove ? 'move' : 'default'),
          i.hasOwnProperty('trueSize') && ((z = i.trueSize[0] / M), (B = i.trueSize[1] / O)),
          i.hasOwnProperty('setSelect') && (K(i.setSelect), Z.done(), delete i.setSelect),
          U.refresh(),
          i.bgColor != W &&
            (nt(i.shade ? U.getShades() : T, (i.shade && i.shadeColor) || i.bgColor),
            (W = i.bgColor)),
          q != i.bgOpacity && ((q = i.bgOpacity), i.shade ? U.refresh() : Z.setBgOpacity(q)),
          (N = i.maxSize[0] || 0),
          (L = i.maxSize[1] || 0),
          (R = i.minSize[0] || 0),
          (A = i.minSize[1] || 0),
          i.hasOwnProperty('outerImage') && (j.attr('src', i.outerImage), delete i.outerImage),
          Z.refresh();
      }
      ...
      var rt = {
          ...
          if (!I) {
            ...
            var y = function () {
              (m += (100 - m) / v),
                ...
                m < 100
                  ? (Q(l), w())
                  : (Z.done(), Z.animMode(!1), 'function' == typeof e && e.call(rt));
            };
            w();
          }
          function w() {
        ...
        release: Z.release,
        destroy: function () {
          T.remove(), C.show(), C.css('visibility', 'visible'), $(t).removeData('Jcrop');
        },
        focus: G.watchKeys,
        getBounds: function () {
          return [M * z, O * B];
  ...
  $(function ($) {
    window.addEventListener('contextmenu', function (t) {
      ...
      chrome_new.runtime.sendMessage(
        {
          msg: 'capture:init',
          data: {
                  ...
                  case 'MdBtn01Save':
                    'note' == p
                      ...
                      l(function (t) {
                        ...
                        chrome_new.downloads.download({ url: i, filename: n }, function (t) {
            ...
            $('#capture').Jcrop(
              {
                onChange: function (t) {
                  if (null != f) {
                    ...
                    var e =
                        Math.abs(t.x - f.clientX) > Math.abs(t.x2 - f.clientX) ? t.x2 : t.x - 60,
                      n = Math.abs(t.y - f.clientY) > Math.abs(t.y2 - f.clientY) ? t.y2 : t.y;
                    r.css({ left: s.left + e, top: s.top + (n - 20) }).text(t.w + ' / ' + t.h),
                      o.hide(),
